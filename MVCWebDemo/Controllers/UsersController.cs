...
namespace MVCWebDemo.Controllers
{
    ...
    {
        private readonly MVCWebDemoContext _context;

        public UsersController(MVCWebDemoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.User != null ? 
                          ...
                          Problem("Entity set 'MVCWebDemoContext.User'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MVCWebDemoContext.User'  is null.");
            }
            var user = await _context.User.FindAsync(id);
            if (user != null)
            {
